            ...
            <Row xs={1} md={2} lg={3} className='my-5'>
                {
                    tasks.map(task => (
                        <Col key={task.task_id}>
                            <Card className='h-100 shadow border rounded-4 p-1 p-lg-3 my-2'>
                                <Card.Body>
                                    <Card.Title>
                                        <h3 className='fw-bold text-primary-emphasis my-3'>
                                            {task.taskName}
                                        </h3>
                                        {
                                            task.isActive ? 
                                            ...
                                            :
                                            <Badge className='bg-success p-2'>Completed</Badge>
                                        }
                                    </Card.Title>
                                    <Card.Text className='text-secondary'>{task.taskDescription}</Card.Text>
                                </Card.Body>
