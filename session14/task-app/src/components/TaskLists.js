...
export default function TaskLists() {
    ...
    const [newEditTask, setNewEditTask] = useState({ taskName: "", taskDescription: "" });
            ...
            <Row xs={1} md={2} lg={3} className='my-3'>
                {
                    tasks.map(task => (
                        <>
                            ...
                            {/* MODAL FOR TASK COMPLETION */}
                            <Modal show={showComplete} onHide={handleCloseComplete} centered size='lg'>
                                <Modal.Header closeButton className='bg-warning p-4'>
                                ...
                                <Modal.Body className='p-3 text-center'>
                                    <h4 className='fw-bold'>
                                        Are you sure you want to mark as done <span className='text-primary'>{selectedTask.taskName.toUpperCase()}</span>?
                                    </h4>
                                </Modal.Body>

                                <Modal.Footer>
                                    <Button type='submit' variant="secondary" className='px-5 rounded-pill p-2' onClick={handleCloseComplete}>
                                        No
                                    </Button>
                            ...
                            <Modal show={showEdit} onHide={handleCloseEdit} centered size='lg'>
                                ...
                                <Form className='p-1 p-lg-3' onSubmit={EditTask}>
                                    <Modal.Body className='p-3'>
                                        ...
                                        <Form.Group className="mb-3">
                                            <Form.Control
                                                ...
                                                placeholder="Task Name"
                                                required
                                                onChange={e => setNewEditTask({ ...newEditTask, taskName: e.target.value })}
                                                value={newEditTask.taskName}
                                            />
                                        </Form.Group>
                                        ...
                                        <Form.Group className="mb-3">
                                            <Form.Control
                                                ...
                                                as="textarea"
                                                rows={5}
                                                onChange={e => setNewEditTask({ ...newEditTask, taskDescription: e.target.value })}
                                                value={newEditTask.taskDescription}
                                            />
                                        </Form.Group>
